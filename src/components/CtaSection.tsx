...
const CtaSection = () => {
  return (
    <section className="relative z-10 w-full py-20 px-6 md:px-12 lg:px-24">
      <div className="max-w-5xl mx-auto text-center bg-gradient-to-r from-qicky-purple to-qicky-blue p-12 rounded-2xl shadow-lg shadow-qicky-purple/30">
        ...
        <Link to="/apply-loan">
          <Button
            size="lg"
            className="bg-white text-qicky-purple px-8 py-3 rounded-full text-lg font-semibold hover:bg-gray-200 transition-colors group"
          >
