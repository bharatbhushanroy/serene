    ...
    <section className="relative w-full min-h-[calc(100vh-80px)] flex items-center justify-center py-16 px-6 md:px-12 lg:px-24 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between w-full max-w-7xl gap-12">
        <div className="flex flex-col items-center lg:items-start text-center lg:text-left max-w-2xl">
          <div className="flex items-center bg-qicky-purple/20 text-qicky-lightblue px-3 py-1 rounded-full text-sm font-medium mb-4">
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
            ...
            <Link to="/about">
              <Button variant="outline" className="bg-transparent border-qicky-textmuted text-qicky-text px-8 py-3 rounded-full text-lg font-semibold hover:bg-qicky-purple/10 hover:border-qicky-purple transition-colors">
                Learn More
              </Button>
            </Link>
          </div>
      ...
      {showCookieBanner && (
        <div className="absolute bottom-0 left-0 right-0 bg-qicky-dark/90 backdrop-blur-sm p-4 flex flex-col md:flex-row items-center justify-between text-qicky-text text-sm border-t border-qicky-border">
          ...
          <div className="flex space-x-2">
            <Button variant="outline" className="border-qicky-textmuted text-qicky-text hover:bg-qicky-purple/10" onClick={() => setShowCookieBanner(false)}>Decline</Button>
