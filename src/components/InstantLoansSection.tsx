...
const InstantLoansSection = () => {
  return (
    <section className="relative bg-brand-dark text-brand-text py-20 sm:py-32 overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            <h2 className="text-4xl sm:text-5xl font-bold mb-6 leading-tight">
              Instant Loans, <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-orange to-brand-light-orange">
                Lightning Fast Approval
              </span>
            </h2>
            <p className="text-lg text-brand-text-muted mb-8 max-w-lg">
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              ...
              <Button size="lg" variant="outline" className="border-brand-orange text-brand-orange hover:bg-brand-orange/10 hover:text-brand-orange">
                How It Works
              </Button>
            </div>
          </motion.div>
