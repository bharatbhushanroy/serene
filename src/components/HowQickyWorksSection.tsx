      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {steps.map((step, index) => (
            <Card key={index} className="bg-fintech-simulator-card-bg backdrop-blur-lg border border-fintech-border-light p-6 rounded-xl shadow-lg flex flex-col items-center text-center h-full transition-all duration-300 hover:border-fintech-blue-accent hover:bg-fintech-dark-bg-lighter">
