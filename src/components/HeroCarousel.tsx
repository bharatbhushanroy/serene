...
const CarouselSlide: React.FC<CarouselSlideProps> = ({ icon: Icon, title, description, iconColor }) => (
  <Card className="w-full max-w-md bg-gradient-dark-card border border-brand-border rounded-xl p-6 shadow-lg flex-shrink-0">
    ...
    <div className="flex items-center justify-end mt-8">
      <Link to="/about">
        <Button variant="ghost" className="text-brand-text-muted hover:text-brand-orange hover:bg-brand-orange/10 transition-colors">
  ...
  const slides = [
    {
      ...
      iconColor: "text-brand-light-orange",
    },
    {
      icon: ShieldCheck,
  ...
  return (
    <div className="relative w-full max-w-md">
      ...
      <div className="absolute bottom-4 left-0 right-0 flex items-center justify-between px-4">
            ...
            <button
              ...
              className={cn(
                ...
                emblaApi && index === emblaApi.selectedScrollSnap()
                  ? "bg-brand-orange"
                  : "bg-brand-text-muted opacity-50"
              )}
        ...
        <div className="flex space-x-2">
          <Button variant="ghost" size="icon" className="text-brand-text-muted hover:bg-brand-orange/10 rounded-full" onClick={scrollPrev}>
            <ArrowRight className="h-5 w-5 rotate-180" />
          </Button>
          <Button variant="ghost" size="icon" className="text-brand-text-muted hover:bg-brand-orange/10 rounded-full" onClick={scrollNext}>
