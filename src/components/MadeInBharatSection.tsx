      ...
      <div className="relative w-full h-auto overflow-hidden mt-4 z-0">
        ...
        >
          ...
          <g fill="hsl(var(--fintech-text-dark))" filter="url(#skylineGlow)"> {/* Brighter fill and apply glow filter */}
            {/* Taj Mahal like structure (simplified) */}
            ...
            {/* India Gate like structure (simplified) */}
            ...
            {/* Qutub Minar like structure (simplified) */}
            <path d="M350 150 L355 80 L360 150 Z" />
            <circle cx="355" cy="75" r="5" />

            {/* Charminar like structure (simplified) */}
            ...
            {/* Lotus Temple like structure (simplified) */}
            ...
            {/* Gateway of India like structure (simplified) */}
