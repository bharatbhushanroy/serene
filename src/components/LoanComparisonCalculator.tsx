    ...
    <section className="relative z-10 w-full py-20 px-6 md:px-12 lg:px-24 text-qicky-text">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-8">
          {/* Loan 1 Card */}
          <Card className="bg-gradient-dark-card border border-qicky-border p-6 rounded-xl shadow-lg">
            <CardHeader>
            ...
            <CardContent className="space-y-8">
              ...
              <div>
                ...
                <Slider
                  ...
                  className="[&>span:first-child]:h-2 [&>span:first-child]:bg-gradient-to-r [&>span:first-child]:from-qicky-purple [&>span:first-child]:to-qicky-blue [&_[role=slider]]:h-5 [&_[role=slider]]:w-5 [&_[role=slider]]:bg-qicky-purple [&_[role=slider]]:border-2 [&_[role=slider]]:border-qicky-purple"
                />
              </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <Label htmlFor="loanARate" className="text-qicky-textmuted flex items-center">
                    <Zap className="h-5 w-5 mr-2 text-qicky-purple" /> Interest Rate
                  </Label>
              ...
              <div>
                ...
                <Slider
                  ...
                  className="[&>span:first-child]:h-2 [&>span:first-child]:bg-gradient-to-r [&>span:first-child]:from-qicky-purple [&>span:first-child]:to-qicky-blue [&_[role=slider]]:h-5 [&_[role=slider]]:w-5 [&_[role=slider]]:bg-qicky-lightblue [&_[role=slider]]:border-2 [&_[role=slider]]:border-qicky-lightblue"
                />
              </div>
            </CardContent>
          </Card>
        ...
        <Card className="bg-gradient-dark-card border border-qicky-border p-6 rounded-xl shadow-lg h-fit">
          <CardHeader>
            <CardTitle className="text-3xl font-bold text-qicky-text mb-6">Loan Comparison</CardTitle>
          </CardHeader>
          <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* EMI (Monthly Payment) */}
            <Card className="bg-qicky-dark/50 border border-qicky-border/50 p-4 rounded-lg">
              ...
              <div className="flex justify-between items-baseline mb-1">
                ...
                <span className="text-qicky-purple font-bold text-xl">
              ...
              <div className="flex justify-around items-center h-full">
                <div className="flex flex-col items-center">
                  <CircularProgressBar
                    ...
                    progressClassName="stroke-qicky-lightblue"
                  />
                ...
                <div className="flex flex-col items-center">
                  <CircularProgressBar
                    ...
                    progressClassName="stroke-qicky-purple"
                  />
