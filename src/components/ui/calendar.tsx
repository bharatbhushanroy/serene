  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        /* caption */
        caption: "relative flex items-center justify-center gap-2",
        caption_label: "hidden",

        /* dropdowns */
        dropdowns: "flex gap-2",
        dropdown:
          "rdp-dropdown h-8 rounded-md border border-border bg-background px-2 text-sm text-foreground focus:outline-none focus:ring-1 focus:ring-ring",
        dropdown_month: "min-w-[130px]",
