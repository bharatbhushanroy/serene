...
const Footer = () => {
  return (
    <footer className="relative z-10 w-full bg-qicky-dark text-qicky-text py-12 px-6 md:px-12 lg:px-24 border-t border-qicky-blue/30">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-8">
        ...
        <div className="col-span-1 flex flex-col items-center md:items-start">
          ...
          <ul className="space-y-2 text-center md:text-left">
            <li><Link to="/privacy" className="text-qicky-textmuted hover:text-qicky-text transition-colors">Privacy Policy</Link></li>
        ...
        <div className="col-span-full md:col-span-4 lg:col-span-1 flex flex-col items-center md:items-end lg:items-start">
          ...
          <div className="flex space-x-4">
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-qicky-textmuted hover:text-qicky-blue transition-colors">
              <Facebook className="h-6 w-6" />
            </a>
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-qicky-textmuted hover:text-qicky-blue transition-colors">
              <Twitter className="h-6 w-6" />
            </a>
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-qicky-textmuted hover:text-qicky-blue transition-colors">
              <Linkedin className="h-6 w-6" />
            </a>
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-qicky-textmuted hover:text-qicky-blue transition-colors">
      ...
      {/* Copyright */}
      <div className="mt-12 pt-8 border-t border-qicky-blue/20 text-center text-sm text-qicky-textmuted">
