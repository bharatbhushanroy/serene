        ...
        <Card className="bg-gradient-dark-card border border-brand-border p-8 rounded-xl shadow-lg max-w-md w-full">
          <CardHeader className="text-center">
            <CardTitle className="text-4xl font-extrabold text-brand-text mb-4">
              Welcome <span className="bg-gradient-to-r from-brand-orange to-brand-light-orange text-transparent bg-clip-text">Back</span>
            </CardTitle>
            <p className="text-brand-text-muted text-lg">Sign in to your Qicky account</p>
          </CardHeader>
          <CardContent>
            ...
            <p className="text-center text-brand-text-muted text-sm mt-6">
              ...
              <Link to="/signup" className="text-brand-orange hover:text-brand-light-orange font-semibold">
                Sign Up
              </Link>
            </p>
          </CardContent>
