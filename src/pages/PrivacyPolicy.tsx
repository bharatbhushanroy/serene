  ...
  return (
    <div className="min-h-screen bg-fintech-background-light text-fintech-text-dark hero-background">
      ...
      <main className="relative z-10 py-20 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto">
        ...
        <div className="bg-gradient-card-light border border-fintech-border-light p-8 rounded-xl shadow-lg text-fintech-text-dark prose max-w-none">
          <h2 className="text-3xl font-bold text-fintech-text-dark mb-4">1. Information We Collect</h2>
          <p>
          ...
          <h2 className="text-3xl font-bold text-fintech-text-dark mt-8 mb-4">2. How We Use Your Information</h2>
          ...
          <h2 className="text-3xl font-bold text-fintech-text-dark mt-8 mb-4">3. Sharing Your Information</h2>
          <p>
          ...
          <h2 className="text-3xl font-bold text-fintech-text-dark mt-8 mb-4">4. Security</h2>
          <p>
          ...
          <h2 className="text-3xl font-bold text-fintech-text-dark mt-8 mb-4">5. Your Choices</h2>
          <p>
          ...
          <h2 className="text-3xl font-bold text-fintech-text-dark mt-8 mb-4">6. Changes to This Policy</h2>
          <p>
          ...
          <h2 className="text-3xl font-bold text-fintech-text-dark mt-8 mb-4">7. Contact Us</h2>
          <p>
