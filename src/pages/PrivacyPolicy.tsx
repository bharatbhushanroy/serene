    ...
    <div className="min-h-screen bg-brand-dark text-brand-text hero-background">
      ...
      <main className="relative z-10 py-20 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto">
        <h1 className="text-5xl md:text-6xl font-extrabold text-center leading-tight mb-8">
          Privacy <span className="bg-gradient-to-r from-brand-orange to-brand-light-orange text-transparent bg-clip-text">Policy</span>
        </h1>
        <p className="text-lg text-brand-text-muted text-center mb-16 max-w-3xl mx-auto">
          Your privacy is important to us. This policy explains how we collect, use, and protect your personal information.
        </p>

        <div className="bg-gradient-dark-card border border-brand-border p-8 rounded-xl shadow-lg text-brand-text prose prose-invert max-w-none">
          <h2 className="text-3xl font-bold text-brand-text mb-4">1. Information We Collect</h2>
          <p>
          ...
          <h2 className="text-3xl font-bold text-brand-text mt-8 mb-4">2. How We Use Your Information</h2>
          ...
          <h2 className="text-3xl font-bold text-brand-text mt-8 mb-4">3. Sharing Your Information</h2>
          <p>
          ...
          <h2 className="text-3xl font-bold text-brand-text mt-8 mb-4">4. Security</h2>
          <p>
          ...
          <h2 className="text-3xl font-bold text-brand-text mt-8 mb-4">5. Your Choices</h2>
          <p>
          ...
          <h2 className="text-3xl font-bold text-brand-text mt-8 mb-4">6. Changes to This Policy</h2>
          <p>
          ...
          <h2 className="text-3xl font-bold text-brand-text mt-8 mb-4">7. Contact Us</h2>
          <p>
