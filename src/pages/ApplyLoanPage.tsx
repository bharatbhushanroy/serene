  ...
  return (
    <div className="min-h-screen bg-qicky-dark text-qicky-text hero-background">
      ...
      <main className="relative z-10 py-20 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto flex items-center justify-center">
        <Card className="bg-gradient-dark-card border border-qicky-blue/30 p-8 rounded-xl shadow-lg max-w-2xl w-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <Select value={loanPurpose} onValueChange={setLoanPurpose}>
                  <SelectTrigger className="w-full bg-qicky-dark border-qicky-blue/50 text-qicky-text focus:border-qicky-blue">
                    <SelectValue placeholder="Select a purpose" />
                  </SelectTrigger>
                  <SelectContent className="bg-qicky-dark border-qicky-blue/50 text-qicky-text">
