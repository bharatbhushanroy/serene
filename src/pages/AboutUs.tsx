      ...
      <main className="relative z-10 py-20 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          <div className="space-y-8">
            ...
            <Card className="bg-gradient-dark-card border border-qicky-border p-8 rounded-xl shadow-lg">
              <div className="flex items-center mb-4">
                <Lightbulb className="h-8 w-8 text-qicky-purple mr-4" />
          ...
          <div className="flex items-center justify-center">
            <img
              ...
              className="w-full max-w-lg rounded-xl shadow-2xl border border-qicky-border object-cover aspect-square"
            />
          </div>
        </div>
        ...
        <div className="text-center">
          <h2 className="text-4xl md:text-5xl font-extrabold leading-tight mb-6">
            Join the <span className="bg-gradient-to-r from-qicky-purple to-qicky-blue text-transparent bg-clip-text">Qicky Family</span>
          </h2>
