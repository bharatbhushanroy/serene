    ...
    <div className="min-h-screen bg-brand-dark text-brand-text hero-background">
      ...
      <main className="relative z-10 py-20 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto">
        <h1 className="text-5xl md:text-6xl font-extrabold text-center leading-tight mb-8">
          About <span className="bg-gradient-to-r from-brand-orange to-brand-light-orange text-transparent bg-clip-text">Qicky</span>
        </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          <div className="space-y-8">
            <Card className="bg-gradient-dark-card border border-brand-border p-8 rounded-xl shadow-lg">
              <div className="flex items-center mb-4">
                <Users className="h-8 w-8 text-brand-light-orange mr-4" />
            ...
            <Card className="bg-gradient-dark-card border border-brand-border p-8 rounded-xl shadow-lg">
              <div className="flex items-center mb-4">
                <Lightbulb className="h-8 w-8 text-brand-orange mr-4" />
                <h2 className="text-3xl font-bold text-brand-text">Our Values</h2>
              </div>
              <ul className="list-disc list-inside text-brand-text-muted text-lg space-y-2">
                <li><span className="font-semibold text-brand-text">Transparency:</span> No hidden fees, clear terms.</li>
                <li><span className="font-semibold text-brand-text">Innovation:</span> Leveraging technology for a better experience.</li>
                <li><span className="font-semibold text-brand-text">Customer Focus:</span> Your needs are our priority.</li>
                <li><span className="font-semibold text-brand-text">Integrity:</span> Honest and ethical practices.</li>
              </ul>
            </Card>
          </div>
          <div className="flex items-center justify-center">
            <img
              ...
              className="w-full max-w-lg rounded-xl shadow-2xl border border-brand-border object-cover aspect-square"
            />
          </div>
        </div>
        ...
        <div className="text-center">
          <h2 className="text-4xl md:text-5xl font-extrabold leading-tight mb-6">
            Join the <span className="bg-gradient-to-r from-brand-orange to-brand-light-orange text-transparent bg-clip-text">Qicky Family</span>
          </h2>
