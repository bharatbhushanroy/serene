        ...
        <Card className="bg-gradient-dark-card border border-qicky-blue/30 p-8 rounded-xl shadow-lg max-w-md w-full">
          <CardHeader className="text-center">
            <CardTitle className="text-4xl font-extrabold text-qicky-text mb-4">
              Join <span className="bg-gradient-to-r from-qicky-pink to-qicky-lightpurple text-transparent bg-clip-text">Qicky</span>
            </CardTitle>
          ...
          <CardContent>
            ...
            <p className="text-center text-qicky-textmuted text-sm mt-6">
              ...
              <Link to="/login" className="text-qicky-blue hover:text-qicky-lightblue font-semibold">
                Login
              </Link>
            </p>
          </CardContent>
