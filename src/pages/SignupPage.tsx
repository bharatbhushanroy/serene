  ...
  return (
    <div className="min-h-screen bg-brand-dark text-brand-text hero-background">
      ...
      <main className="relative z-10 py-20 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto flex items-center justify-center">
        <Card className="bg-gradient-dark-card border border-brand-border p-8 rounded-xl shadow-lg max-w-md w-full">
          <CardHeader className="text-center">
            <CardTitle className="text-4xl font-extrabold text-brand-text mb-4">
              Join <span className="bg-gradient-to-r from-brand-orange to-brand-light-orange text-transparent bg-clip-text">Qicky</span>
            </CardTitle>
            <p className="text-brand-text-muted text-lg">Create your account to get started</p>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <Label htmlFor="name" className="text-brand-text-muted mb-2 block">Full Name</Label>
                <Input
                  id="name"
                  type="text"
              ...
              <div>
                <Label htmlFor="email" className="text-brand-text-muted mb-2 block">Email</Label>
                <Input
                  id="email"
                  type="email"
              ...
              <div>
                <Label htmlFor="password" className="text-brand-text-muted mb-2 block">Password</Label>
                <Input
                  id="password"
                  type="password"
                  placeholder="••••••••"
            ...
            <p className="text-center text-brand-text-muted text-sm mt-6">
              ...
              <Link to="/login" className="text-brand-orange hover:text-brand-light-orange font-semibold">
                Login
              </Link>
            </p>
          </CardContent>
