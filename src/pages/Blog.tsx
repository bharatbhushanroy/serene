    ...
    <div className="min-h-screen bg-qicky-dark text-qicky-text hero-background">
      ...
      <main className="relative z-10 py-20 px-6 md:px-12 lg:px-24 max-w-7xl mx-auto">
        <h1 className="text-5xl md:text-6xl font-extrabold text-center leading-tight mb-8">
          Our <span className="bg-gradient-to-r from-qicky-purple to-qicky-blue text-transparent bg-clip-text">Blog</span>
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogPosts.map((post) => (
            <Card key={post.id} className="bg-gradient-dark-card border border-qicky-border rounded-xl shadow-lg overflow-hidden">
              ...
              <div className="p-6">
                ...
                <Link to={`/blog/${post.id}`} className="text-qicky-purple hover:text-qicky-blue font-semibold transition-colors">
                  Read More &rarr;
                </Link>
              </div>
            </Card>
